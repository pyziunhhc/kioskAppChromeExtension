...
class Navigation {
    ...
    createBar() {
        const body = document.querySelector('body'),
            ...
            showTabsButton = new Button('\u25b2', null, null, ['show-tabs__button']); //document.createElement('button');
    ...
    createTabsMenu(e, body) {
        ...
        if (isExist) {
            ...
            chrome.storage.sync.get('barConfiguration', (data) => {
                ...
                e.classList.remove('show') e.classList.add('hidden')
                //e.innerText = '\u25BC';
                const port = chrome.runtime.connect({
                    name: "tabs"
                }); port.postMessage({
                ...
                }); tabsContainer.appendChild(tabsList); body.appendChild(tabsContainer)
            }
        }
    }
