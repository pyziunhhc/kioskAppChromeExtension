...
class Navigation {
    ...
    createBar() {
        const body = document.querySelector('body'),
            ...
            showTabsSpan = document.createElement('span'); //document.createElement('button');
        const pages = new Pages(menuContainer);
        ...
        showTabsSpan.button.addEventListener('click', this.createTabsMenu.bind(null, showTabsButton.button, body))
        ...
        showTabsButton.button.appendChild(showTabsSpan)
